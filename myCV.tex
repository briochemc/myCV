...
\hypersetup{
    ...
    allcolors=earthblue,         % color of internal links (change box color with linkbordercolor)
...
\newpage
\printbibsection{inproceedings}{Con{\color{pblue}f}erence {\color{pblue}Pres}entations}
